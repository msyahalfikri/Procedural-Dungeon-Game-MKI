...
namespace DungeonLiberation
{
    public class PlayerLocomotion : MonoBehaviour
    {
        ...
        [SerializeField]
        float groundDetectionRayOffset = 0.2f;
        ...
        public void HandleFalling(float delta, Vector3 moveDirection)
        {
            ...
            dir.Normalize();
            origin += dir * groundDetectionRayOffset;

            targetPosition = myTransform.position;

            Debug.DrawRay(origin, -Vector3.up * minimumFallDistance, Color.red, 0.2f, false);

            if (Physics.Raycast(origin, -Vector3.up, out hit, minimumFallDistance, ignoreGroundCheck))
            {
